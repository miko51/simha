    ...
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      <section className="mt-16">
        ...
        <p className="text-[var(--muted)] mt-4 max-w-2xl text-lg">
          Budget, échéancier, invités, rétroplanning et déroulé des jours J — plus un assistant IA ancré sur le calendrier juif (paracha, nérot, Omer). Les prestataires publient leur page (logo, site, coordonnées) et apparaissent selon votre ville.
        </p>
      ...
      <section className="grid md:grid-cols-3 gap-4 mt-16">
        {[
          ...
          ["Prestataires", "Salle, traiteur, DJ, déco, fleuriste… chaque enseigne a une page complète. Créez un compte pour la gérer."],
        ].map(([t, d]) => (
